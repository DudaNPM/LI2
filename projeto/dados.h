...
@param coord Coordenada 1
@param coord Coordenada 2
@returns 1 se iguais, 0 caso contrário
*/
int compara_coordenadas(COORDENADA coord1, COORDENADA coord2);


/**
\brief Altera o valor da linha de uma coordenada
...
/**
\brief Altera o valor da coluna de uma coordenada
@param coord Coordenada em questão
